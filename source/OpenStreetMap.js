...
OpenLayers.Layer.OSM.Mapnik = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({ numZoomLevels: 19 }, options); //19
        var newArguments = [name, url, options];
...
OpenLayers.Layer.OSM.Osmarender = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({ numZoomLevels: 19 }, options); //18
        var newArguments = [name, url, options];
        OpenLayers.Layer.OSM.prototype.initialize.apply(this, newArguments);
    },
...
OpenLayers.Layer.OSM.Maplint = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({ numZoomLevels: 19, isBaseLayer: false, visibility: false }, options); //19
        var newArguments = [name, url, options];
        OpenLayers.Layer.OSM.prototype.initialize.apply(this, newArguments);
    },
